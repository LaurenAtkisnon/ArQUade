class tatorHallway2 extends Phaser.Scene {
  constructor() {
    super("tatorHallway2");
  }
  ...
  create() {
    const background = this.add.image(400,300,"tatorHallway2");
    background.scale = .3;
    ...
    //settings
    this.setting();
    this.navigationButtons("tatorHallway2", "tatorHallway2","tatorHall130",this.getLastLocation());
    ...
    //right button should go to TatorHall130
