class tatorHall130 extends Phaser.Scene {
  constructor() {
    super("tatorHall130");
  }
  ...
  preload() {
    ...
    this.load.image("tatorHall130", "pictures/tatorHall130.png");
  ...
  create() {
    const background = this.add.image(400,300,"tatorHall130");
    background.scale = .3;
    ...
    //backwards button should go to tatorHallway2

    //forwards button should go to insideTatorHall130
