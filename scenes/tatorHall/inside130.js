//copied from wholeTator3

class inside130 extends Phaser.Scene {
  constructor() {
    super("inside130");
  }
  ...
  create() {
    this.background = this.add.image(400,300,"th130.png"); //th130.png is the photo INSIDE 130
    this.background.scale = .275;
    this.setting();

    //technically only need a back button to go back to the hallway
