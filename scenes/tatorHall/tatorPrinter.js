...
class tatorPrinter extends Phaser.Scene {
  constructor() {
    super("tatorPrinter");
  }
  ...
  create() {
    this.background = this.add.image(400,300,""); //not too sure which picture we are supposed to use
    this.background.scale = .275;
    this.setting();
    this.navigationButtonsTest("wholeTator3","wholeTator","wholeTator2","wholeTator3");
  }

  //we have all 4 directions for this and should be good
